...
namespace pet_system_alarm_api.DAL
{
    public static class DbInitializer
    {
        public static void Initialize(PetAlarmSystemContext context)
        {
            ...
            {
                new Person(){ Name="Administrator",Lastname="Administrator",DateBirth="02/10/2021",Address="Remote location",Email="administrator@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "administrator@gmail.com", Password = EncryptDecrypt.EncryptString("administrator")},
                new Person(){ Name="Camila",Lastname="Smith",DateBirth="05/03/1983",Address="Ilac Centre, Henry Street, Dublin 1 ",Email="camila.smith@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "camila.smith@gmail.com", Password = EncryptDecrypt.EncryptString("camila")},
                new Person(){ Name="Emily",Lastname="Marinkovic",DateBirth="02/09/1988",Address="Autoaddress, 4 Inns Court, Winetavern Street, Dublin 8, D08 XY01",Email="emily.marinkovic@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "emily.marinkovic@gmail.com", Password = EncryptDecrypt.EncryptString("emily")},
                new Person(){ Name="Luciana",Lastname="Arismendi",DateBirth="08/01/1989",Address="5 Inns Court, Winetavern Street, Dublin 8, D08 XY00",Email="luciana.arismaendi@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "luciana.arismaendi@gmail.com", Password = EncryptDecrypt.EncryptString("luciana")},
                new Person(){ Name="Sandra",Lastname="Blanco",DateBirth="06/03/1985",Address="New Company Ltd, D08 XY00",Email="sandra.blanco@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "sandra.blanco@gmail.com", Password = EncryptDecrypt.EncryptString("sandra")},
                new Person(){ Name="Patrick",Lastname="Lemark",DateBirth="01/08/1992",Address="Silver Birches",Email="patrick.lemark@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "patrick.lemark@gmail.com", Password = EncryptDecrypt.EncryptString("patrick")},
                new Person(){ Name="Pablo",Lastname="Johnson",DateBirth="10/09/1997",Address="Silver birches, Meath",Email="pablo.johnson@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "pablo.johnson@gmail.com", Password = EncryptDecrypt.EncryptString("pablo")},
                new Person(){ Name="Julian",Lastname="Raducu",DateBirth="04/08/1989",Address="Chancery, Turlough, Castlebar, Co. Mayo",Email="julian.raducu@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "julian.raducu@gmail.com", Password = EncryptDecrypt.EncryptString("julian")},
                new Person(){ Name="Ignacio",Lastname="Gates",DateBirth="10/02/1992",Address="Silver Birches, Millfarm, Dunboyne, Co. Meath",Email="ignacio.gates@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "ignacio.gates@gmail.com", Password = EncryptDecrypt.EncryptString("ignacio")},
                new Person(){ Name="Julie",Lastname="Williams",DateBirth="06/12/1982",Address="Cavalry House, Clancy Quay, Islandbridge, Dublin 8",Email="julie.williams@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "julie.williams@gmail.com", Password = EncryptDecrypt.EncryptString("julie")},
                new Person(){ Name="Joel",Lastname="Amador",DateBirth="02/11/1990",Address="Autoaddress, 4 Inns Court, Winetavern Street, Dublin 8",Email="joel.amador@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "joel.amador@gmail.com", Password = EncryptDecrypt.EncryptString("joel")},
                new Person(){ Name="Fatima",Lastname="Suarez",DateBirth="05/12/1986",Address="8 Silver Birches, Dunboyne, Meath",Email="fatima.suarez@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "fatima.suarez@gmail.com", Password = EncryptDecrypt.EncryptString("fatima")},
                new Person(){ Name="Sophie",Lastname="Sherif",DateBirth="02/06/1990",Address="Autoaddress, 4 Inns Court, Winetavern Street, Dublin 8, D08 XY00",Email="sophie.sherif@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "sophie.sherif@gmail.com", Password = EncryptDecrypt.EncryptString("sophie")},
                new Person(){ Name="Dario",Lastname="Thompson",DateBirth="03/05/1993",Address="5 Inns Court, Winetavern Street, Dublin 8, D0B XY00",Email="dario.thompson@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "dario.thompson@gmail.com", Password = EncryptDecrypt.EncryptString("dario")},
                new Person(){ Name="Luis",Lastname="Simpson",DateBirth="02/07/1996",Address="NewCo at Debenhams, Henry Street, Dublin 1 D01 A3T6",Email="luis.simpson@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "luis.simpson@gmail.com", Password = EncryptDecrypt.EncryptString("luis")},
                new Person(){ Name="Erick",Lastname="Stradivarius",DateBirth="03/04/1982",Address="Pavilion, The University of Dublin Trinity College, Dublin 2",Email="erick.stradivarius@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "erick.stradivarius@gmail.com", Password = EncryptDecrypt.EncryptString("erick")},
                new Person(){ Name="John",Lastname="Lee",DateBirth="04/10/1991",Address="Middle Earth, Winetavern Street, Dublin 8",Email="john.lee@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "john.lee@gmail.com", Password = EncryptDecrypt.EncryptString("john")},
                new Person(){ Name="Julio",Lastname="Iglesias",DateBirth="05/09/1981",Address="NewCo at Debenhams, Henry Street, Dublin 1 D01 A2T6",Email="julio.iglesias@gmail.com", IdNumber=new Random().Next(0, 1000000) + "-S", PhoneNumber = new Random().Next(0, 65788118).ToString(),Username = "julio.iglesias@gmail.com", Password = EncryptDecrypt.EncryptString("julio")}
            };
